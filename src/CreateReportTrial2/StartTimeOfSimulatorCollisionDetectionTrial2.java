...
public class StartTimeOfSimulatorCollisionDetectionTrial2 {
	public static void main(String[] args) {
		StartTimeOfSimulatorCollisionDetectionTrial2.getStartTimeOfSimulator();
	}
	...
	public static String getStartTimeOfSimulator() {
		...
		try {
			XMLInputFactory factory = XMLInputFactory.newInstance();
			 String filname=FileName.FILENAME_TRIAL_2;
			XMLEventReader eventReader = factory
					.createXMLEventReader(new FileReader(FileName.PATH+filname));
