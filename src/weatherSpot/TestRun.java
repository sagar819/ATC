	...
	public static void main(String[] args) {
	    ...
	    //  System.out.println("diffInSeconds :"+diffInMillies/1000l);
	     ...
	     HashMap <String,Long> mapTimeDiffInSec = getTimeDiffStartAccept(startTS, dateMap);
	      ...
	      System.out.println("Acceptance Time : 1. 0-Threshold seconds(too early) : +7 points ");
	      System.out.println("Acceptance Time : 2. Threshold-Threshold+28 seconds(optimum time) : +10 points ");
	      System.out.println("Acceptance Time : 3. Threshold+28-Threshold+28+28 seconds(late) : +6 points ");
	      System.out.println("Acceptance Time : 4. Threshold+28+28-above seconds(too late) : +3 points ");
	      System.out.println("Acceptance Time : 5. never accepted : +0 points ");
	      System.out.println();
//	      System.out.println("---Grading Criteria of AirCB1---");
//	      System.out.println("Points/Credits Classification , ");
//	      System.out.println("Acceptance Time : 1. 0-32 seconds(too early) : +7 points ");
...
//	      System.out.println("Acceptance Time : 5. never accepted : +0 points ");
	      ...
	      if(currentTSInSecAirCB1 != null) {
	      	  if (currentTSInSecAirCB1 > 0 && currentTSInSecAirCB1 < threshold_AirCB1) {
	        	  ...
	        	  totalScoreAirCB1 = totalScoreAirCB1 + 3;
	          }
	      }
	          System.out.println(" Score of AirCB1: "+totalScoreAirCB1+"/10");
		      ...
		      if(currentTSInSecAirCB8 != null) {
		      	  if (currentTSInSecAirCB8 > 0 && currentTSInSecAirCB8 < threshold_AirCB8) {
		        	  ...
		        	  totalScoreAirCB8 = totalScoreAirCB8 + 3;
		          }
		      }
		          System.out.println(" Score of AirCB8: "+totalScoreAirCB8+"/10");
			      ...
			      if(currentTSInSecAirCB6 != null) {
			      	  if (currentTSInSecAirCB6 > 0 && currentTSInSecAirCB6 < threshold_AirCB6) {
			        	  ...
			        	  totalScoreAirCB6 = totalScoreAirCB6 + 3;
			          }
			      }
			          System.out.println(" Score of AirCB6: "+totalScoreAirCB6+"/10");
				      ...
				      if(currentTSInSecAirCB15 != null) {
				      	  if (currentTSInSecAirCB15 > 0 && currentTSInSecAirCB15 < threshold_AirCB15) {
				        	  ...
				        	  totalScoreAirCB15 = totalScoreAirCB15 + 3;
				          }
				      }
				          System.out.println(" Score of AirCB15: "+totalScoreAirCB15+"/10");
					      ...
					      if(currentTSInSecAirCB10 != null) {
					      	  if (currentTSInSecAirCB10 > 0 && currentTSInSecAirCB10 < threshold_AirCB10) {
					        	  ...
					        	  totalScoreAirCB10 = totalScoreAirCB10 + 3;
					          }
					      }
					          System.out.println(" Score of AirCB10: "+totalScoreAirCB10+"/10");
						      ...
						      if(currentTSInSecAirCB9 != null) {
						      	  if (currentTSInSecAirCB9 > 0 && currentTSInSecAirCB9 < threshold_AirCB9) {
						        	  ...
						        	  totalScoreAirCB9 = totalScoreAirCB9 + 3;
						          }
						      }
						          System.out.println(" Score of AirCB9: "+totalScoreAirCB9+"/10");
							      ...
							      if(currentTSInSecAirCB4 != null) {
							      	  if (currentTSInSecAirCB4 > 0 && currentTSInSecAirCB4 < threshold_AirCB4) {
							        	  ...
							        	  totalScoreAirCB4 = totalScoreAirCB4 + 3;
							          }
							      }
							          System.out.println(" Score of AirCB4: "+totalScoreAirCB4+"/10");
								      ...
								      if(currentTSInSecAirCB7 != null) {
								      	  if (currentTSInSecAirCB7 > 0 && currentTSInSecAirCB7 < threshold_AirCB7) {
								        	  ...
								        	  totalScoreAirCB7 = totalScoreAirCB7 + 3;
								          }
								      }
								          System.out.println(" Score of AirCB7: "+totalScoreAirCB7+"/10");
									      ...
									      if(currentTSInSecAirCB12 != null) {
									      	  if (currentTSInSecAirCB12 > 0 && currentTSInSecAirCB12 < threshold_AirCB12) {
									        	  ...
									        	  totalScoreAirCB12 = totalScoreAirCB12 + 3;
									          }
									      }
									          System.out.println(" Score of AirCB12: "+totalScoreAirCB12+"/10");
									          grandTotal=grandTotal+totalScoreAirCB12;
						          
	        //  Long totalScore3=(long) (totalScore1+totalScore2);
	        //  System.out.println(" Score of AirCB1: "+totalScore2 +"/10");
	        System.out.println("Total Score of Trial 1 : "+grandTotal+"/90");
