...
public class AcceptedTimeOfAirCraftUsingHashMap {
	   ...
	   boolean isAccepted = false;
	     ...
	     // double elapsedTime;
	      ...
	      try {
	         ...
	         factory.createXMLEventReader(new FileReader("XML_files/"+filname));
...
System.out.println();
//ArrayList<CDDetectedPojo> colliedAirCraftsSorted = new ArrayList<CDDetectedPojo>();
