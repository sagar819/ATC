...
public class ElapsedTimeAtActionTerminatedForFile2 {
	public static void main(String[] args) {
		...
		try {
			...
			XMLEventReader eventReader = factory.createXMLEventReader(new FileReader("XML_files/Trial2.xml.log"));
		...
		System.out.println("For file :  Trail2.xml.log");
